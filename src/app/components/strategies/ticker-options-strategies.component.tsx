...
export const TickerOptionsStrategiesComponent: React.FC = observer(() => {
    ...
    const currentTab = services.localStorage.getItem(AppLocalStorageKeys.currentStrategyTab) || CONDORS_TAB;
    ...
    return (
        <IonTabs className={STRATEGIES_TABS_CSS_CLASS}>
            ...
            <IonTabBar slot="top"
                       onIonTabsDidChange={e => services.localStorage.setItem(AppLocalStorageKeys.currentStrategyTab, e.detail.tab)}>
